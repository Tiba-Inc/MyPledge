...
const LevelsRookie = (props: SvgProps) => (
  <Svg width={69} height={74} viewBox="0 0 69 74" fill="none" {...props}>
    <G filter="url(#filter0_d_59465_2271)">
      <Path
        ...
        fill="url(#paint0_linear_59465_2271)"
      />
      <G filter="url(#filter1_d_59465_2271)">
        <Path
          ...
          fill="url(#paint1_linear_59465_2271)"
        />
        <Path
          opacity={0.18}
          ...
          fill="url(#paint2_radial_59465_2271)"
          fillOpacity={0.5}
        />
      </G>
      <Path
      ...
      />
      <Path
        d="M31.9997 18.5C27.9163 18.5 23.833 25.885 23.833 31.3333C23.833 35.8483 27.4847 39.5 31.9997 39.5C36.5147 39.5 40.1663 35.8483 40.1663 31.3333C40.1663 25.885 36.083 18.5 31.9997 18.5ZM33.1663 36C29.6663 36 27.333 33.6783 27.333 30.1667C27.333 29.525 27.858 29 28.4997 29C29.1413 29 29.6663 29.525 29.6663 30.1667C29.6663 33.5733 32.4897 33.6667 33.1663 33.6667C33.808 33.6667 34.333 34.1917 34.333 34.8333C34.333 35.475 33.808 36 33.1663 36Z"
        fill="#8A4A65"
      />
    </G>
    <Defs>
      <LinearGradient
        id="paint0_linear_59465_2271"
        x1={3.96963}
        y1={28.9908}
        x2={60.0121}
        y2={28.9908}
