...
const Wants = (props: Props) => {
  const pieData = [
    { value: 25, color: 'transparent', focused: true }, // Needs (hidden)
    { value: 35, color: '#fce186', focused: true }, // Wants (hidden)
    { value: 40, color: 'transparent' }, // Savings (visible and focused)
  ];

  const legendData = [{ title: 'Wants', subtitle: 'UGX. 0.0 left', color: '#fce186' }];
  return (
    <View>
